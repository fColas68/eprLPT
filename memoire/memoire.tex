...
Coffman \emph{et al.} \cite{coffman1978application} utilisent Bin-packing 
  ...
  l'heuristique MULTIFITS (algorithme \ref{algo:MULTIFIT}). 
Cet algorithme est basé sur FFD (algorithme \ref{algo:FFD}), un outil (heuristique) 
  de résolution de Bin-packing. 
