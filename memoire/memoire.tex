...
En faisant évoluer $n$ de 10 à 1000 et $m$ de 5 à 50, 
  ...
  le Makespan relatif le plus bas 
...
\caption{comparaison LPT et SLACK sur 3 distributions 
  avec $10\leq n \leq 1000$ et $5\leq m \leq 50$}
...
Cartographier chaque relation

IL y a trop de variables pour en sortir un schéma de causalité, 
  ou pas assez pour en déduire un comportement général. 

principe de randomisation est essentiel 


le périmètre d'expérimentation est constitué d'un échantillon biaisé, 
