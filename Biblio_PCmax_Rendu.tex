...
\item identiques.
  ...
  l'autre);
\item uniformes (un quotient de vitesse qi propre à une machine est à
...
\begin{definition1}{\problemGraham}
  ...
  \problemGraham consiste à planifier un ensemble J~=~\{1,2,{\dots},n)
...
P{\textbar}{\textbar}C\textsubscript{max} est un problème NP-Difficile
au sens fort \citep{garey1982computers}.
Cependant, \problemGraham devient un problème NP-Difficile, du moment
...
cas \problemGraham) n'est pas réaliste.
...
% ENSEMBLE DES JOBS J
% -------------------------------------------------------
\item un ensemble de n jobs (ou tâches) $J = \{1, 2, ..., n\}$ Chaque
  job j a un temps de traitement connu
  $p\textsubscript{j} P = \{p\textsubscript{1}, p\textsubscript{2},
  ..., p\textsubscript{n}\}$
...
le problème \problemGraham toujours dans une instance où le ratio
...
Le problème Bin-packing, est semblable au problème \problemGraham.
